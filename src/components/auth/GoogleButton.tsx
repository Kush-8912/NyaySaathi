...
export default function GoogleButton({ label = 'Continue with Google' }: GoogleButtonProps) {
  ...
  return (
    <button type="button" onClick={handleGoogle} style={{
      ...
      padding: '0.8rem 1rem', borderRadius: 10, background: 'rgba(255,255,255,0.06)',
    ...
    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.1)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(99,102,241,0.3)'; }}
    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.06)'; (e.currentTarget as HTMLElement).style.borderColor = 'var(--border-default)'; }}
    >
